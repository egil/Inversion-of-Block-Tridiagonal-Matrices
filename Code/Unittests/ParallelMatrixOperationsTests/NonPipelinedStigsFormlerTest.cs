...
namespace ParallelMatrixOperationsTests
{
    ...
    /// <summary>
    ///This is a test class for NonPipelinedStigsFormlerTest and is intended
    ///to contain all NonPipelinedStigsFormlerTest Unit Tests
    ///</summary>
    [TestClass()]
    public class NonPipelinedStigsFormlerTest
    {
        ...
        public void NonPipelinedStigsFormlerInverse_GENDATA_LARGE()
        {
            var tileSize = 30;
            ...
            //var btm = BlockTridiagonalMatrix<double>.DeSerializeFromFile(@"C:\Users\eh\Documents\KU\Inversion-of-Block-Tridiagonal-Matrices\Dataset\ds10x100x200.dat");
        ...
        [TestMethod()]
        public void NonPipelinedStigsFormlerInverse_GENDATA_Test1()
        {
            var tileSize = 30;
        ...
        [TestMethod]
        public void NonPipelinedStigsFormlerInverse_MAPLE_Test3()
        {
            ...
            expected[3, 3] =
                new Matrix<double>(new double[,]
                                       {
                                           {
                                               0.006795680721, -0.003345499683, -0.007641172897, -0.004353925957,
                                               -0.01410339266, 0.003869228511, 0.001769547911, 0.008694746891,
                                               -0.009154466413, -0.004659479776
                                           },
                                           {
                                               -0.0002725263809, -0.002959167310, -0.003322278044, 0.0004765092169,
                                               -0.002958780732, -0.0006945064862, 0.002740262240, 0.002976602695,
                                               -0.005787844252, 0.0008060767293
                                           },
                                           {
                                               -0.0003756413772, 0.001418378431, 0.002663785813, 0.003734373141,
                                               -0.0003388411208, 0.003562850775, 0.0009321072150, 0.004444501696,
                                               -0.001190270584, 0.003442954998
                                           },
                                           {
                                               0.004039788990, 0.001287781270, 0.0009522293080, -0.001279976216,
                                               0.001300881754, 0.001758181043, 0.002749120995, 0.001911703271,
                                               -0.004371407110, -0.003363517961
                                           },
                                           {
                                               -0.005319281401, 0.003021257099, -0.003479613784, 0.009788730650,
                                               -0.0002040771298, 0.003391715239, 0.001123177698, 0.0004507254914,
                                               0.001170687060, 0.004565306107
                                           },
                                           {
                                               -0.002337367218, -0.003582973591, -0.0007427825444, 0.006569960214,
                                               -0.003852050310, 0.0008362366927, 0.002960503379, 0.003435767612,
                                               -0.0003888959350, -0.0006628691683
                                           },
                                           {
                                               -0.01171054500, 0.005373504183, 0.0005243112333, 0.005642595478,
                                               0.01110609246, -0.002431802483, -0.004155759571, -0.0003052253043,
                                               0.003181794947, 0.005337586877
                                           },
                                           {
                                               0.003376376559, 0.0005831196346, -0.004326307426, -0.0007281127829,
                                               -0.001730844195, -0.001642138679, 0.0003542778432, -0.002287586078,
                                               0.0001262407869, -0.004046488793
                                           },
                                           {
                                               0.006630818431, -0.005185274071, -0.003289414099, -0.004179922095,
                                               -0.01135382023, 0.002054978228, 0.005249680383, 0.004398316503,
                                               -0.008808737275, -0.005440853080
                                           },
                                           {
                                               -0.008411006367, 0.001087800435, -0.002960391419, 0.003597340279,
                                               0.006752210806, 0.002439721898, 0.0009924718875, 0.005708681188,
